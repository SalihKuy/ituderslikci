...
function App() {
  ...
  return (
    <div id="dark" onClick={handleHelp} style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
      ...
      {isHelperOpen && helperStep == 1 && <p src={left} alt="Icon" style={{ position: "absolute", top: "50%", left: "40%", transform: "translateY(-50%)", width: "500px", height: "100px", zIndex: "1000", color: "#333333", backgroundColor: "#87cefa", borderRadius: "10px", padding: "10px" }}>{language == "en" ? "First thing you need to do is exiting Chrome if it's already running. Then launch Chrome by pressing this button and log in to your itu account by going to the itu obs. You should then go to the Course Enrollment page and keep it open (https://obs.itu.edu.tr/ogrenci/DersKayitIslemleri/DersKayit). If you close Chrome, you need to do this step again." : "İlk olarak yapman gereken Chrome açıksa kapamak. Sonra bu butona basarak Chrome'u başlatmak ve itü obs sitesine gidip hesabına giriş yapmak. Daha sonra ders seçimi kısmına gelip o sayfayı açık bırakman gerek (https://obs.itu.edu.tr/ogrenci/DersKayitIslemleri/DersKayit). Chrome'u kapatırsan bu adımı baştan yapmalısın."}</p>}
